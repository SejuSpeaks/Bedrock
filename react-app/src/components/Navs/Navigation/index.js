				...
				{!sessionUser && (
					<div className='sign-up-buttons'>
						<div className='session-buttons-container'>
							<NavLink className='navlink session-buttons' to='/login'>Log in</NavLink>
						</div>

						<div className='session-buttons-container'>
							<NavLink className='navlink session-buttons' to='/signup'>Sign up</NavLink>
						</div>
					...
					<div className='logged-in-links-nav'>
						{sessionUser.artist_account && (
							...
							<div onClick={() => history.push('/albums/new')}>
								<i className="fa-solid fa-square-plus fa-xl upload-album-container" style={{ "color": "black" }}></i>
							</div>
						)}
